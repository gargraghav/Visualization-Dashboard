function draw_brush(result,pol1,pol2){
    console.log(result);
	pol3 = 'DeathCount'
    ...
    function scatterplot(onBrush) {
        var margin = { top: 100, right: 15, bottom: 40, left: 75 }
	    ...
	    svg.append("text")
	        ...
	        .text("Scatter Plot of Pollutants");
    ...
    function choropleth1(features) {
        ...
        var div = d3.select("body").append("div")
		    ...
		    svg.append("text")
		        ...
		        //.style("text-decoration", "underline")
		        .style("font-weight", "bold")
		        .text("Distribution of Death by Geography")
		        .style("z-index",10);
        ...
        return function update(data) {
            svg.selectAll('path')
                ...
                .style('fill', function (d) { return d.filtered ? '#ddd' : color(d.z_data) })
        }
